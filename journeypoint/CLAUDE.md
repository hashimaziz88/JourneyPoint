...
7. keep JourneyPoint-owned handwritten frontend source files at or under 350
   lines, excluding generated build output
8. move loose helper methods, constants, interfaces, and sample data into
   dedicated modules or top-level folders instead of large component or
   provider files
9. keep providers on the strict four-file contract only
10. do not declare regular nested React components inside component bodies
11. normalize older external company notes to JourneyPoint's App Router and
