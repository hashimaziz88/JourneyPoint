...
namespace JourneyPoint.Migrations
{
    ...
    [Migration("20260330124326_AddEngagementPersistence")]
    partial class AddEngagementPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JourneyPoint.Domains.Engagement.AtRiskFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ClassificationAtRaise")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "HireId")
                        .IsUnique()
                        .HasFilter("\"Status\" <> 3");

                    b.HasIndex("TenantId", "RaisedAt");

                    b.HasIndex("TenantId", "Status");

                    b.HasIndex("TenantId", "HireId", "Status");

                    b.ToTable("AtRiskFlags", (string)null);
                });

            modelBuilder.Entity("JourneyPoint.Domains.Engagement.EngagementSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "HireId", "ComputedAt");

                    b.HasIndex("TenantId", "JourneyId", "ComputedAt");
