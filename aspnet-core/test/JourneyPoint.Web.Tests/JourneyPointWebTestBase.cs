...
using JourneyPoint.Models.TokenAuth;
...
{
    public abstract class JourneyPointWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static JourneyPointWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(JourneyPointWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<JourneyPointDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<JourneyPointDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<JourneyPointDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<JourneyPointDbContext, Task<T>> func)
        {
            T result;
